...
@Component
class MonthlyActivityMapper {

    MonthlyActivity mapToDomain(MonthlyActivityEntity entity) {
    ...
    MonthlyActivityEntity mapToEntity(MonthlyActivity activity) {
        return MonthlyActivityEntity.builder()
                .id(activity.id())
                .type(activity.type())
